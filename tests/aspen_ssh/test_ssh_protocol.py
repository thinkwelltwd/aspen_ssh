import binascii
import pytest
from aspen_ssh.protocol.ssh_protocol import (
    pack_ssh_mpint,
    _hex_characters_length,
    pack_ssh_uint32,
    pack_ssh_uint64,
    pack_ssh_string,
)
...
def test_strings():
    strings = {
        ...
        'abc': binascii.unhexlify('00000003616263'),
        b'1234': binascii.unhexlify('0000000431323334'),
        '1234': binascii.unhexlify('0000000431323334'),
    }
...
def test_mpint_known_answers():
    ...
    mpints = {
        int(0): binascii.unhexlify('00000000'),
        int(0x9a378f9b2e332a7): binascii.unhexlify('0000000809a378f9b2e332a7'),
        int(0x80): binascii.unhexlify('000000020080'),
        int(-0x1234): binascii.unhexlify('00000002edcc'),
...
def test_mpints():
    mpints = {
        int(-1): binascii.unhexlify('00000001ff'),
        int(1): binascii.unhexlify('0000000101'),
        int(127): binascii.unhexlify('000000017f'),
        int(128): binascii.unhexlify('000000020080'),
        int(-128): binascii.unhexlify('0000000180'),
        int(-129): binascii.unhexlify('00000002ff7f'),
        int(255): binascii.unhexlify('0000000200ff'),
        int(256): binascii.unhexlify('000000020100'),
        int(-256): binascii.unhexlify('00000002ff00'),
        int(-257): binascii.unhexlify('00000002feff'),
    }
    for known_input, known_answer in mpints.items():
        assert known_answer == pack_ssh_mpint(known_input)
...
def test_uint32():
    uint32s = {
        0x00: binascii.unhexlify('00000000'),
        0x0a: binascii.unhexlify('0000000a'),
        0xab: binascii.unhexlify('000000ab'),
        0xabcd: binascii.unhexlify('0000abcd'),
        0xabcdef: binascii.unhexlify('00abcdef'),
        0xffffffff: binascii.unhexlify('ffffffff'),
        0xf0f0f0f0: binascii.unhexlify('f0f0f0f0'),
        0x0f0f0f0f: binascii.unhexlify('0f0f0f0f'),
    }
...
def test_uint64():
    uint64s = {
        0x00: binascii.unhexlify('0000000000000000'),
        0x0a: binascii.unhexlify('000000000000000a'),
        0xab: binascii.unhexlify('00000000000000ab'),
        0xabcd: binascii.unhexlify('000000000000abcd'),
